...
public class OrderHistoryItemLiteAdapter extends RecyclerView.Adapter<OrderHistoryItemLiteAdapter.OrderItemViewHolder> implements Filterable {
    ...
    public OrderHistoryItemLiteAdapter(List<OrderHistoryItemEntity> list) {
        this.list = list;
    }
    ...
    public OrderItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new OrderHistoryItemLiteAdapter.OrderItemViewHolder(view);
    }
